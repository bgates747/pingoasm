...
import build_earth_party_tex as party
...
class EarthPartySourceTests(unittest.TestCase):
    def test_profile_has_six_unique_portable_models(self) -> None:
        ...
        self.assertEqual(
            ...
            "apps/earth-party-tex/assets/stars.tsv",
        )
        ...
        self.assertTrue(
            all(model.get("shading", "textured") == "textured" for model in models)
        )

    def test_modern_lighting_and_star_policy_matches_flat_edition(self) -> None:
        ...
        self.assertNotRegex(
            source,
            r"(?ims)ld\s+hl\s*,\s*(?:jet|airliner)_mid\s*.*?"
