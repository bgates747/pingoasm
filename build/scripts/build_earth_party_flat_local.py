...
APP_ROOT = PROJECT_ROOT / "apps" / "earth-party-flat-local"
...
GENERATOR = "build/scripts/build_earth_party_flat_local.py"
...
def load_profile() -> dict[str, Any]:
    ...
    if profile.get("name") != "earth-party-flat-local":
        raise ValueError("profile name must be earth-party-flat-local")
...
def build() -> Path:
    ...
    try:
        ...
        write_pose_cycle_include(
            ...
            generator=GENERATOR,
            authoritative_input="apps/earth-party-flat-local/profile.json",
        )
