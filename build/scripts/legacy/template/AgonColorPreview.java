...
public class AgonColorPreview {

    public static void main(String[] args) {
        // Set your parameters here directly
        String filepath = "src/blender/bayarea.png";  // Replace with your image path
        int numcolors = 64;  // Set to 16 or 64
        String method = "RGB";  // Set to "HSV" or "RGB"

        try {
            BufferedImage originalImage = ImageIO.read(new File(filepath));
            BufferedImage convertedImage = AgonColors.convertToAgonPalette(originalImage, numcolors, method);
            ...
            String newFilename = file.getParent() + File.separator + baseName + ".jv." + method.toLowerCase() + "." + numcolors + extension;
