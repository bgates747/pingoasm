; =============================================================================
; Current-Pingo Jet client with eZ80-owned object-local transforms.
;
...
vdp_version:
    db "Pingo eZ80 local-transform Jet",0
...
; The complete initial object state was synchronized during initialization.
; Submit one unconditional render so a static scene is displayed.
...
; Only synchronize object state when the renderer is idle. p3d_object_sync16
; clears the submitted dirty bits; motion during the new in-flight render sets
; them again for the following submission.
    ld ix,object_state
