; =============================================================================
; Standalone TurboVega-surface textured-triangle regression fixture.
; Adapted from pingoasm apps/moveobj/src/tri.asm.
; =============================================================================
...
vdp_version: db "Pingo TurboVega triangle regression",0
